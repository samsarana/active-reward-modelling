...
python main.py --env=frozen_lake --RL_baseline --n_runs=1 --n_rounds=1 --lr_agent=1e-3 --default_settings=openai --info=RL_fl_opai_1e-3
python main.py --env=frozen_lake --RL_baseline --n_runs=1 --n_rounds=1 --lr_agent=5e-4 --default_settings=openai --info=RL_fl_opai_5e-4
python main.py --env=frozen_lake --RL_baseline --n_runs=1 --n_rounds=1 --lr_agent=1e-4 --default_settings=openai --info=RL_fl_opai_1e-4