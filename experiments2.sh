...
python main.py --info=active-MC-k10-p.1 --active_learning=info_gain --num_MC_samples=10 --p_dropout_rm=0.1
python main.py --info=active-MC-k100-p.1 --active_learning=info_gain --num_MC_samples=100 --p_dropout_rm=0.1
