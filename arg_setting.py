...
def parse_arguments():
    ...
    parser.add_argument('--n_labels_per_round', type=int, nargs='+', default=[500,1600,800,400,200,100], help='How many labels to acquire per round? (in main training loop). len should be n_rounds + 1, since 0th is pretraining labels')
