...
\hline 
Communication efficiency & On the order of hundreds of bits per human hour & Much richer in information than trajectory preferences (Ibarz et al. show that demonstrations half the amount of human time required to achieve the same level of performance) & Scalar rewards provide richer information than binary preferences over trajectories, but not as rich as demonstrations \\ 
\hline 
Computational efficiency & On the order of 10 million learning time steps (in Atari environments) & On the order of 10 million learning time steps (in Atari environments) & On the order of thousands of time steps (in Atari environments)* \\ 
\hline
\end{tabularx}
